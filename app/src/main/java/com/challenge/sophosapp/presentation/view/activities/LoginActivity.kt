...
import com.challenge.sophosapp.domain.definitions.Constants.DEFAULT_BOOLEAN
...
import com.challenge.sophosapp.databinding.ActivityLoginBinding
import com.challenge.sophosapp.domain.models.UserResponseDto
import com.challenge.sophosapp.presentation.viewmodel.LoginViewModel
...
class LoginActivity :
    ...
    private val editTextWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
            val enabled = !binding.emailEditText.text.isNullOrEmpty()
                    &&
    ...
    private fun saveSharedPreferences() {
        ...
        with(sharedPreferences.edit()) {
            ...
            putBoolean(getString(R.string.preferences_admin_key), userInfo.admin ?: false) // OPERADOR ELVIS ?:
    ...
    private fun manageLoginButtonVisuals(enabled: Boolean) {
        ...
        if (enabled) {
            binding.loginWithCredentialsButton.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(this, R.color.main_color))
        } else {
